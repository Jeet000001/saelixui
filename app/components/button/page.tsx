...
export default GradientAnimationButtonDemo;`}
        ...
        {/* Text Glowing Button */}
        <ShowComponent
          ComponentName="12. Animated Text"
          installation="npx saelix-ui add animated-text-button"
          ComponentCodeTS={`import Animated_Text_Button from "@/components/ui/Animated-text-button";

const AnimatiedtextButtonDemo = () => {
  return <button>Hover Me</button>;
};
export default AnimatiedtextButtonDemo;;
`}
          ComponentCodeJS={`import Animated_Text_Button from "./components/ui/Animated-text-button";
