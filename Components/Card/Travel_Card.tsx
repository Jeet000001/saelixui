...
const Travel_Card: React.FC<TravelCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-4 right-4 bg-white/25 backdrop-blur-md p-2 rounded-full
      dark:bg-[#1F2937]/80"
      >
      ...
      <div
        className="absolute right-4 top-[52%] bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full text-white font-semibold text-sm
      ...
      <div className="absolute bottom-0 w-full p-5 text-white dark:text-[#E5E7EB]">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <div
            className="bg-white/20 backdrop-blur px-3 py-1 rounded-full text-xs flex items-center gap-1 font-medium
