...
export default function ShowComponent({
  ...
  return (
    <div className="flex justify-center items-start px-4 sm:px-6 md:px-10 py-4">
      <div
        className="w-full max-w-3xl rounded-xl border border-gray-200 bg-white shadow-sm
        dark:bg-[#111827] dark:border-[#1F2937] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)]"
      >
        <div
          className="flex items-center justify-between border-b border-gray-300 px-4 py-3
          dark:border-[#1F2937]"
        >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div
            className="w-full max-w-2xl max-h-130 rounded-xl bg-white flex flex-col
            dark:bg-[#111827] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6)]"
          >
            <div
              className="sticky top-0 z-20 border-b rounded-t-xl border-gray-300 pb-2 bg-white
            ...
            >
              ...
              <div
                className="mx-5 mb-3 flex items-center justify-between gap-2 rounded-lg border-2 border-gray-200 px-4 py-3 text-sm
